...
IF EXISTS (SELECT name FROM master.sys.databases WHERE name = N'ALEXAMARA')
begin 
drop database  ALEXAMARA;
...
INSERT INTO ServiceRequest
VALUES
(6,11,4,'Electric-flush system periodically stops functioning. Diagnose and repair.','Open','3','0',null);
INSERT INTO ServiceRequest
VALUES
...
INSERT INTO ServiceRequest
VALUES
(11,2,3,'Air conditioning unit shuts down with HHH showing on the control panel.','Technician not able to replicate the problem. Air conditioning unit ran fine through multiple tests. Owner to notify technician if the problem recurs.','1','1',null);
INSERT INTO ServiceRequest
VALUES
